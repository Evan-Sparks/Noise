...
if __name__ == "__main__":
    n = Scale(Worley2d(), 256)
    draw_image(n, name="Examples/Worley.png")
    ...
    # n = Scale(FracalNoise(Abs(PerlinNoise3d())), 400)
    # draw_image(n, name="Examples/FractalTurbulentNoise.png")
